...
export declare const DisplayFieldsResponse: import("superstruct").Struct<{
    ...
    data: import("superstruct").Struct<Record<string, string> | null, null>;
...
export declare const SuiObjectData: import("superstruct").Struct<{
     ...
     */
    storageRebate: import("superstruct").Struct<string | undefined, null>;
    /**
...
export declare const PaginatedObjectsResponse: import("superstruct").Struct<{
    ...
    nextCursor: import("superstruct").Struct<string | {
        objectId: string;
        atCheckpoint?: number | undefined;
    } | null, null>;
