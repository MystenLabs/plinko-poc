...
var SuiTransaction = union3([
  ...
  object4({ MakeMoveVec: tuple2([nullable3(string4()), array3(SuiArgument)]) })
]);
var SuiCallArg = union3([
  object4({
    type: literal3("pure"),
    valueType: nullable3(string4()),
    value: SuiJsonValue
  }),
  object4({
...
var MutableReferenceOutputType = tuple2([
  SuiArgument,
  array3(number3()),
  string4()
]);
...
import { nullable as nullable4, number as number4, object as object5, string as string5 } from "superstruct";
...
// src/types/faucet.ts
import { array as array4, nullable as nullable5, number as number5, object as object6, string as string6 } from "superstruct";
...
var CoinStruct = object9({
  ...
  lockedUntilEpoch: optional5(nullable7(number8())),
  previousTransaction: TransactionDigest
});
...
var EpochInfo = object10({
  ...
  referenceGasPrice: nullable8(number9())
});
...
import { array as array9, boolean as boolean8, nullable as nullable9, object as object11, string as string11 } from "superstruct";
...
var CheckpointPage = object12({
  ...
  nextCursor: nullable10(string12()),
...
var DynamicFieldType = union6([
  literal6("DynamicField"),
  literal6("DynamicObject")
]);
...
import {
  RequestManager as RequestManager2,
  Client as Client2,
  WebSocketTransport
...
import { any as any6, array as array15, string as string18, nullable as nullable13 } from "superstruct";
import { fromB58 as fromB582, toB64 as toB646, toHEX as toHEX2 } from "@mysten/bcs";
...
var option = (some) => union7([
  object14({ None: union7([literal7(true), literal7(null)]) }),
  object14({ Some: some })
]);
...
var MakeMoveVecTransaction = object14({
  ...
  type: optional7(option(record4(string14(), unknown()))),
  objects: array12(ObjectTransactionArgument)
});
...
var TransactionExpiration = optional8(
  nullable12(
    union9([
      ...
      object16({ None: union9([literal8(true), literal8(null)]) })
    ])
  )
);
