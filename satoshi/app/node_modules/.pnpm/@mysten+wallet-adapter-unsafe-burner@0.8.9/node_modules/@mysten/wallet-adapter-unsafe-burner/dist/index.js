...
__export(src_exports, {
  UnsafeBurnerWalletAdapter: () => UnsafeBurnerWalletAdapter
});
module.exports = __toCommonJS(src_exports);
var import_sui = require("@mysten/sui.js");
var import_wallet_standard = require("@mysten/wallet-standard");
var _provider, _keypair, _signer, _account;
var UnsafeBurnerWalletAdapter = class {
  constructor(network = import_sui.localnetConnection) {
    ...
    this.signMessage = async (messageInput) => {
      return __privateGet(this, _signer).signMessage({ message: messageInput.message });
    };
    this.signTransactionBlock = async (transactionInput) => {
      return __privateGet(this, _signer).signTransactionBlock({
        transactionBlock: transactionInput.transactionBlock
      });
    };
    this.signAndExecuteTransactionBlock = async (transactionInput) => {
      return await __privateGet(this, _signer).signAndExecuteTransactionBlock({
        transactionBlock: transactionInput.transactionBlock,
    ...
    __privateSet(this, _keypair, new import_sui.Ed25519Keypair());
    __privateSet(this, _provider, new import_sui.JsonRpcProvider(network));
    __privateSet(this, _account, new import_wallet_standard.ReadonlyWalletAccount({
      ...
      publicKey: __privateGet(this, _keypair).getPublicKey().toBytes()
    }));
    __privateSet(this, _signer, new import_sui.RawSigner(__privateGet(this, _keypair), __privateGet(this, _provider)));
  ...
  async connect() {
    ...
    try {
      __privateGet(this, _signer).requestSuiFromFaucet();
    } catch (e) {
      console.warn(
