...
function createWalletKitCore({
  ...
  let internalState = {
    accounts: [],
    currentAccount: null,
    wallets: sortWallets((0, import_wallet_adapter_base.resolveAdapters)(adapters), preferredWallets),
    currentWallet: null,
  ...
  const providers = adapters.filter(import_wallet_adapter_base.isWalletProvider);
  if (providers.length) {
    providers.map(
