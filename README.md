...
## Interaction Flowcharts and Sequence Diagrams
...
flowchart TD
    A(Start) --> B
    B[/Game ID and BLS Signature/] --> C
    C[Verify Signature]:::purple --> D
    D[Calculate Outcome]:::purple --> E
    E[Distribute Winnings]:::purple --> F
    F[/Outcome Event/]:::purple --> G
    G(End)
    classDef purple fill:#8470FF
```
